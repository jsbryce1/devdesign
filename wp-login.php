<!DOCTYPE html>
	...
	<title>Log In &lsaquo; Jared Bryce &#8212; WordPress</title>
...
<form name="loginform" id="loginform" action="https://jsbryce1.github.io/devdesign/wp-login.php" method="post">
	<p>
	...
	<p class="submit">
		...
		<input type="hidden" name="redirect_to" value="https://jsbryce1.github.io/devdesign/wp-admin/" />
		<input type="hidden" name="testcookie" value="1" />
	</p>
</form>

<p id="nav">
	<a href="https://jsbryce1.github.io/devdesign/wp-login.php?action=lostpassword">Lost your password?</a>
</p>
