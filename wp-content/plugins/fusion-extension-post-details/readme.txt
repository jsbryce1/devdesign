=== Fusion Page Builder : Extension - Post Details ===
Contributors: agencydominion
Tags: admin, custom, builder, page builder, layout builder, layout, page, columns, multi-column, grid, responsive, shortcode, bootstrap, blog, post, post meta
...
2. Install Fusion : Extension - Post Details through the WordPress plugins screen, or upload the plugin files to the `/wp-content/plugins` directory.
3. Activate Fusion : Extension - Post Details through the 'Plugins' screen in WordPress
4. Visit the Fusion knowledge base and user guide at <http://agencydominion.helpscoutdocs.com/>

== Frequently Asked Questions ==

= Does the Fusion : Extension - Post Details plugin require the Fusion core plugin to function? =

Yes. The Fusion : Extension - Post Details plugin is an extension for adding a Post Details element to Fusion. The Fusion core plugin must be installed for this plugin to function. You can get Fusion [here](https://wordpress.org/plugins/fusion/).
...
= 1.2.0 =
* Add option to output the post excerpt.
...
= 1.0.0 =
* Fusion : Extension - Post Details initial launch.
