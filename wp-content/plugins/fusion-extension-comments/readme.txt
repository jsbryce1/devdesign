=== Fusion Page Builder : Extension - Comments ===
Contributors: agencydominion
Tags: admin, custom, builder, page builder, layout builder, layout, page, columns, multi-column, grid, responsive, shortcode, bootstrap, blog, post, comments
...
2. Install Fusion : Extension - Comments through the WordPress plugins screen, or upload the plugin files to the `/wp-content/plugins` directory.
3. Activate Fusion : Extension - Comments through the 'Plugins' screen in WordPress
4. Visit the Fusion knowledge base and user guide at <http://agencydominion.helpscoutdocs.com/>

== Frequently Asked Questions ==

= Does the Fusion : Extension - Comments plugin require the Fusion core plugin to function? =

Yes. The Fusion : Extension - Comments plugin is an extension for adding a Comments element to Fusion. The Fusion core plugin must be installed for this plugin to function. You can get Fusion [here](https://wordpress.org/plugins/fusion/).
...
= 1.0.0 =
* Fusion : Extension - Comments initial launch.
